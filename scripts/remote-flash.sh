...
# program fpga
ssh ${program_host} "sudo /usr/local/bin/papilio-prog -b papilioloadermod/papilio-prog/bscan_spi_lx9.bit -f ${tmp_bit_file} -a ${flash_location}:${tmp_bit_file} -v" &&
